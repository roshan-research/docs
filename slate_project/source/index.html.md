...
__Description__: آدرس سند ورودی
...
__Description__: این ویژگی نوع سند را مشخص می‌کند
...
__Description__: در صورت فعال بودن این ویژگی، الفبا سعی می‌کند چرخش ۹۰، ۱۸۰ و یا ۲۷۰ درجه تصویر را اصلاح کند
...
__Description__: در صورت فعال بودن این ویژگی اطلاعات مکانی واژه‌ها در خروجی قرار می‌گیرد
...
__Description__: فایل سند ورودی
