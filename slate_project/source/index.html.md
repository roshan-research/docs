...
-------------------------
__Key__: document_url


__Value__: URL 


__TypeAttributes__: required 

__Description__: <p style="direction:rtl;">آدرس سند ورودی</p>
...
__Description__: <p style="direction:rtl;">این ویژگی نوع سند را مشخص می‌کند</p>

-------------------------
__Key__: fix_orientation


__Value__: true 


__Description__: <p style="direction:rtl;">در صورت فعال بودن این ویژگی، الفبا سعی می‌کند چرخش ۹۰، ۱۸۰ و یا ۲۷۰ درجه تصویر را اصلاح کند</p>

-------------------------
__Key__: word_positions


__Value__: true  


__Description__: <p style="direction:rtl;">در صورت فعال بودن این ویژگی اطلاعات مکانی واژه‌ها در خروجی قرار می‌گیرد
</p>
...
__Description__: <p style="direction:rtl;">فایل سند ورودی</p>
